...
using EventSystem = UnityEngine.UIElements.EventSystem;

namespace UIToolkitXRAdapter.XRAdapter{
    [RequireComponent(typeof(RectTransform), typeof(EventSystem))]
    public class XRInputWrapper : InputWrapper {
        ...
        private void Awake() {
            // this.AsOrThrow<EventSystem>().inputOverride = this;
